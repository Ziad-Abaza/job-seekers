<?php
session_start();
include("controller/Auth/reset_password.php");
?>
        ...
        <div class="form-container">
            <div class="reset-container text-center h-100" id="reset-password">
                <div class="top p-3 m-auto">
                    <header class="fs-3">Forgot Password</header>
                </div>
                <form method="post" action="#" class="body-form">
                    ...
                    <div class="form-box-section">
                        <input type="submit" class="submit btn btn-primary" name="submit" value="Send Reset Link">
                    </div>
                </form>
