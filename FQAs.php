        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="faq-item">
                    ...
                    <p>UI/UX Designers need skills in user research, wireframing, prototyping, visual design, and proficiency in design tools like Sketch, Adobe XD, or Figma.</p>
                </div>
                <div class="faq-item">
                ...
                <div class="faq-item">
                    ...
                    <p>Database Administrators need skills in database management systems like MySQL, SQL Server, or Oracle. They should also have knowledge of database security, backup and recovery, and performance tuning.</p>
                </div>
                <div class="faq-item">
                    <h2>6. What roles are available in Network Engineering?</h2>
                    <p>Network Engineers are responsible for designing, implementing, and managing computer networks. They may specialize in areas like network security, routing and switching, or wireless technologies.</p>
                </div>
                <div class="faq-item">
